...
![](https://img-blog.csdnimg.cn/a9cabd07a11f4e57ad4b8633c7a96fbf.png#pic_center)
> * $\sigma$为正态分布的标准差，$\sigma$越大图像越模糊、越平滑
> * $r$为模糊半径，指模板元素到模板中心的距离

二维空间的高斯计算公式：
![](https://img-blog.csdnimg.cn/891cda6a5d9947f09aeedd1320437274.png#pic_center)
> * $\sigma$为正态分布的标准差，$\sigma$越大图像越模糊、越平滑
> * m,n为二维模板的大小m*n
> * x,y为模板上元素的位置(x,y)
...
![](https://img-blog.csdnimg.cn/4eb72ca69eff401d90080b0faf21cf16.png#pic_cener)

利用此高斯模板矩阵与原图像做卷积，即可获得原图像的高斯模糊图像。卷积过程示意图如下：

![](https://img-blog.csdnimg.cn/c208e378440142c29f8e881601ecb15b.png#pic_center)
![](https://img-blog.csdnimg.cn/b7ba0b343a3244e88019fb73cad42150.png#pic_center)
...
![](https://img-blog.csdnimg.cn/5ef78746aaae4369ba5904dabefe2532.png#pic_center)
...
![](https://img-blog.csdnimg.cn/60ae78a332ed4ab2af32178e95c44b89.png#pic_center)

其中$\sigma$为尺度因子，$\sigma$越小对应模糊程度越小，相应的尺度约小。因此大尺度对应图像的概貌特征，小尺度对应图像的细节特征。

![](https://img-blog.csdnimg.cn/041c44970ca84b2a8748fd57d8f6c087.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBASGFsZl9B,size_18,color_FFFFFF,t_70,g_se,x_16)
...
![](https://img-blog.csdnimg.cn/9a15faa85627464295e6884bba69a748.png#pic_center)
> M,N：原图像大小
> t：塔顶图像的最小维度的对数值

![](https://img-blog.csdnimg.cn/207e787cde7d43668e91576e78de0e59.png#pic_center)
...
![](https://img-blog.csdnimg.cn/fe8ce70755074e33a8e97788f4feccc2.png#pic_center)
...
离散空间的极值点不是图像真正的极值点。
![](https://img-blog.csdnimg.cn/9a7f0f46e51e49299e789caee962ff46.png#pic_center)

为了提高关键点的稳定性，需要对尺度空间函数进行曲线拟合。利用尺度空间函数的Taylor展开式，导数在极值点处为0，求得$x$的偏移量实现对关键点的精确定位。

将尺度空间函数$D(x,y,\sigma)$进行泰勒展开，使原点与采样点重合。

![](https://img-blog.csdnimg.cn/938cb1371bd64589baba485ee92b59a5.png#pic_center)
...
![](https://img-blog.csdnimg.cn/5e5f63ef6cc6489db8c0160f4322eead.png#pic_center)

其特征值正比于D的主曲率，由于我们只需要特征值的比值$r$，因此可以避免求出特征值的结果。设$\alpha$为较大的特征值，$\beta$为较小的特征值，取$\alpha=r\beta$，利用迹和行列式的特点：

![image-20211221160722943](C:\Users\82785\AppData\Roaming\Typora\typora-user-images\image-20211221160722943.png)



![image-20211221160923915](C:\Users\82785\AppData\Roaming\Typora\typora-user-images\image-20211221160923915.png)
...
![](https://img-blog.csdnimg.cn/b342809371534552a521cb70dbf9b37a.png#pic_center)

### 4.2 梯度统计

完成关键点的梯度计算后，使用直方图统计邻域内像素的梯度和方向。梯度直方图将0~360°方向分为36份，每个柱子代表10°范围，如图直方图的峰值代表关键点的主方向。

![](https://img-blog.csdnimg.cn/156b7d01be104c159c37cca843393209.png#pic_center)
...
![](https://img-blog.csdnimg.cn/562624cacb3943b2b6e784db25537108.png#pic_center)
